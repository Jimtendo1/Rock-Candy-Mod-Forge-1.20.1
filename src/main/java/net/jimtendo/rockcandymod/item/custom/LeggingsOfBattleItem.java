...
public class LeggingsOfBattleItem extends CustomArmorItem {
    public LeggingsOfBattleItem(ModArmorMaterials condensedCandyOfBattle, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_BATTLE, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_battle.line1"));
