...
public class BootsOfAgilityItem extends CustomArmorItem {
    public BootsOfAgilityItem(ModArmorMaterials condensedCandyOfAgility, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_AGILITY, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_agility.line1"));
