...
public class HoeOfHasteItem extends HoeItem {
    public HoeOfHasteItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
