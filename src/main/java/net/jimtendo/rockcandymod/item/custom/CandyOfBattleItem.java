...
public class CandyOfBattleItem extends Item {
    public CandyOfBattleItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy.strength2"));
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy.fire_resistance"));
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy.slowness2"));
