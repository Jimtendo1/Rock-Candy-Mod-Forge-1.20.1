...
public class HelmetOfPurityItem extends CustomArmorItem {
    public HelmetOfPurityItem(ModArmorMaterials condensedCandyOfPurity, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_PURITY, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_purity.line1"));
