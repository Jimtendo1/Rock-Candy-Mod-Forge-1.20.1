...
public class HelmetOfAgilityItem extends CustomArmorItem {
    public HelmetOfAgilityItem(ModArmorMaterials condensedCandyOfAgility, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_AGILITY, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_agility.line1"));
