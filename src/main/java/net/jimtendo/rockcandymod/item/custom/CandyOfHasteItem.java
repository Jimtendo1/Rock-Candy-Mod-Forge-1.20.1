...
public class CandyOfHasteItem extends Item {
    public CandyOfHasteItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy.health_boost1"));
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy.haste3"));
