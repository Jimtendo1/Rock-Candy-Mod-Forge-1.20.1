...
public class BootsOfPowerItem extends CustomArmorItem {
    public BootsOfPowerItem(ModArmorMaterials condensedCandyOfPower, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_POWER, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_power.line1"));
