...
public class BootsOfStealthItem extends CustomArmorItem {
    public BootsOfStealthItem(ModArmorMaterials condensedCandyOfStealth, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_STEALTH, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_stealth.line1"));
