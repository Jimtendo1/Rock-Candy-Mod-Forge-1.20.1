...
public class CondensedCandyOfDestructionItem extends Block {
    public CondensedCandyOfDestructionItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        ...
        pTooltip.add(Component.translatable("tooltip.rockcandymod.candy_of_destruction"));
