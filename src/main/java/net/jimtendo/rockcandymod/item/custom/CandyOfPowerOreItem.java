...
public class CandyOfPowerOreItem extends Block {
    public CandyOfPowerOreItem(Properties pProperties, UniformInt uniformInt) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        ...
        pTooltip.add(Component.translatable("tooltip.rockcandymod.candy_of_power"));
