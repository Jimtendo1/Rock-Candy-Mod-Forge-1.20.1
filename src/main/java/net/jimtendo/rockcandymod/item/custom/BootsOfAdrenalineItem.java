...
public class BootsOfAdrenalineItem extends CustomArmorItem {
    public BootsOfAdrenalineItem(ModArmorMaterials condensedCandyOfAdrenaline, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_ADRENALINE, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_adrenaline.line1"));
