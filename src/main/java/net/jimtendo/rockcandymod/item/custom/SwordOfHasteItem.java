...
public class SwordOfHasteItem extends SwordItem {
    public SwordOfHasteItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
