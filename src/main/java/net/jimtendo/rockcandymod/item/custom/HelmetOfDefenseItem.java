...
public class HelmetOfDefenseItem extends CustomArmorItem {
    public HelmetOfDefenseItem(ModArmorMaterials condensedCandyOfDefense, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DEFENSE, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_defense.line1"));
