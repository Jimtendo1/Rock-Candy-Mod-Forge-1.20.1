...
public class ChestplateOfBattleItem extends CustomArmorItem {
    public ChestplateOfBattleItem(ModArmorMaterials condensedCandyOfBattle, Type chestplate, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_BATTLE, Type.CHESTPLATE, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.chestplate_of_battle.line1"));
