...
public class PickaxeOfAdrenalineItem extends PickaxeItem {
    public PickaxeOfAdrenalineItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            if (mainHandItem.getItem() instanceof PickaxeOfAdrenalineItem) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.candy_of_adrenaline"));
