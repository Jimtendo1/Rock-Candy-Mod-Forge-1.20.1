...
public class LeggingsOfDefenseItem extends CustomArmorItem {
    public LeggingsOfDefenseItem(ModArmorMaterials condensedCandyOfDefense, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DEFENSE, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_defense.line1"));
