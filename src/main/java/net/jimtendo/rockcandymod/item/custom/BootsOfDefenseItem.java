...
public class BootsOfDefenseItem extends CustomArmorItem {
    public BootsOfDefenseItem(ModArmorMaterials condensedCandyOfDefense, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DEFENSE, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_defense.line1"));
