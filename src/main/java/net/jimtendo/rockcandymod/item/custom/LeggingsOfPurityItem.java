...
public class LeggingsOfPurityItem extends CustomArmorItem {
    public LeggingsOfPurityItem(ModArmorMaterials condensedCandyOfPurity, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_PURITY, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_purity.line1"));
