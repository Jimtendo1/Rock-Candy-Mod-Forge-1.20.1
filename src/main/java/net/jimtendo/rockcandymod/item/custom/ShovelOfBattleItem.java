...
public class ShovelOfBattleItem extends ShovelItem {
    public ShovelOfBattleItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
