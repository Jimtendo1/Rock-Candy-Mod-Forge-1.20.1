...
public class LeggingsOfAdrenalineItem extends CustomArmorItem {
    public LeggingsOfAdrenalineItem(ModArmorMaterials condensedCandyOfAdrenaline, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_ADRENALINE, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_adrenaline.line1"));
