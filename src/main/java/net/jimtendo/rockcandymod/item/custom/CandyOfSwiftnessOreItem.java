...
public class CandyOfSwiftnessOreItem extends Block {
    public CandyOfSwiftnessOreItem(Properties pProperties, UniformInt uniformInt) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        ...
        pTooltip.add(Component.translatable("tooltip.rockcandymod.candy_of_swiftness"));
