...
public class BootsOfSwiftnessItem extends CustomArmorItem {
    public BootsOfSwiftnessItem(ModArmorMaterials condensedCandyOfSwiftness, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_SWIFTNESS, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_swiftness.line1"));
