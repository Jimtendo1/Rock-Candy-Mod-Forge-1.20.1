...
public class BootsOfPurityItem extends CustomArmorItem {
    public BootsOfPurityItem(ModArmorMaterials condensedCandyOfPurity, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_PURITY, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_purity.line1"));
