...
public class ChestplateOfHasteItem extends CustomArmorItem {
    public ChestplateOfHasteItem(ModArmorMaterials condensedCandyOfHaste, Type chestplate, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_HASTE, Type.CHESTPLATE, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.chestplate_of_haste.line1"));
