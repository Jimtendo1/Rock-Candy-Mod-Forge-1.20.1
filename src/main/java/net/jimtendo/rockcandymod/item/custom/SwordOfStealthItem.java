...
public class SwordOfStealthItem extends SwordItem {
    public SwordOfStealthItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
