...
public class LeggingsOfStealthItem extends CustomArmorItem {
    public LeggingsOfStealthItem(ModArmorMaterials condensedCandyOfStealth, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_STEALTH, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_stealth.line1"));
