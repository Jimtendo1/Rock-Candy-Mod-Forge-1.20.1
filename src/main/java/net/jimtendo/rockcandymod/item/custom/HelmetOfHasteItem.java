...
public class HelmetOfHasteItem extends CustomArmorItem {
    public HelmetOfHasteItem(ModArmorMaterials condensedCandyOfHaste, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_HASTE, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_haste.line1"));
