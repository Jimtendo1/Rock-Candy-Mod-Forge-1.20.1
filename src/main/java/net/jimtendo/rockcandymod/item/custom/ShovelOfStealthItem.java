...
public class ShovelOfStealthItem extends ShovelItem {
    public ShovelOfStealthItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
