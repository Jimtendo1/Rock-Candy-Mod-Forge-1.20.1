...
public class HelmetOfDestructionItem extends CustomArmorItem {
    public HelmetOfDestructionItem(ModArmorMaterials condensedCandyOfDestruction, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DESTRUCTION, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_destruction.line1"));
