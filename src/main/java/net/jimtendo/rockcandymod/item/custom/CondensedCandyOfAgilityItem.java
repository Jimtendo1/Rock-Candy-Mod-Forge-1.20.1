...
public class CondensedCandyOfAgilityItem extends Block {
    public CondensedCandyOfAgilityItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable BlockGetter pLevel, List<Component> pTooltip, TooltipFlag pFlag) {
        ...
        pTooltip.add(Component.translatable("tooltip.rockcandymod.candy_of_agility"));
