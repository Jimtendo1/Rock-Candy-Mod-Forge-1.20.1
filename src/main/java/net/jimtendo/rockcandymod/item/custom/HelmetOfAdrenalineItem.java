...
public class HelmetOfAdrenalineItem extends CustomArmorItem {
    public HelmetOfAdrenalineItem(ModArmorMaterials condensedCandyOfAdrenaline, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_ADRENALINE, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_adrenaline.line1"));
