...
public class LeggingsOfHasteItem extends CustomArmorItem {
    public LeggingsOfHasteItem(ModArmorMaterials condensedCandyOfHaste, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_HASTE, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_haste.line1"));
