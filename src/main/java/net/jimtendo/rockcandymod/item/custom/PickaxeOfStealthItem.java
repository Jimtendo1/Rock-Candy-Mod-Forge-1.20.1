...
public class PickaxeOfStealthItem extends PickaxeItem {
    public PickaxeOfStealthItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
