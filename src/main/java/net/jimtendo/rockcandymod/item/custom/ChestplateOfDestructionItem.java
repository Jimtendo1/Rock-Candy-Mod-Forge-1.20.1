...
public class ChestplateOfDestructionItem extends CustomArmorItem {
    public ChestplateOfDestructionItem(ModArmorMaterials condensedCandyOfDestruction, Type chestplate, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DESTRUCTION, Type.CHESTPLATE, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.chestplate_of_destruction.line1"));
