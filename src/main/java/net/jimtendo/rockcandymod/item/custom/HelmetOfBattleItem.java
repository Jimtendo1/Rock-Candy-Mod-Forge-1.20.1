...
public class HelmetOfBattleItem extends CustomArmorItem {
    public HelmetOfBattleItem(ModArmorMaterials condensedCandyOfBattle, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_BATTLE, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_battle.line1"));
