...
public class BootsOfDestructionItem extends CustomArmorItem {
    public BootsOfDestructionItem(ModArmorMaterials condensedCandyOfDestruction, Type boots, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_DESTRUCTION, Type.BOOTS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.boots_of_destruction.line1"));
