...
public class HelmetOfSwiftnessItem extends CustomArmorItem {
    public HelmetOfSwiftnessItem(ModArmorMaterials condensedCandyOfSwiftness, Type helmet, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_SWIFTNESS, Type.HELMET, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.helmet_of_swiftness.line1"));
