...
public class LeggingsOfSwiftnessItem extends CustomArmorItem {
    public LeggingsOfSwiftnessItem(ModArmorMaterials condensedCandyOfSwiftness, Type leggings, Properties pProperties) {
        super(ModArmorMaterials.CONDENSED_CANDY_OF_SWIFTNESS, Type.LEGGINGS, pProperties);
    }

    @Override
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.rockcandymod.leggings_of_swiftness.line1"));
