...
public class SwordOfDestructionItem extends SwordItem {
    public SwordOfDestructionItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (event.phase == TickEvent.Phase.END) {
            ...
            if (mainHandItem.getItem() instanceof SwordOfDestructionItem) {
