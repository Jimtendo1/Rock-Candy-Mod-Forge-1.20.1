...
public class PickaxeOfBattleItem extends PickaxeItem {
    public PickaxeOfBattleItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
